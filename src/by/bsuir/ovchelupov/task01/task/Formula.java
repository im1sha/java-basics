package by.bsuir.ovchelupov.task01.task;
...
public class Formula {
    ...
    /**
     * Private constructor to prevent an instance creation
     */
    private Formula() {
    }
     ...
     */
    public static double calculateExpression(double x, double y) throws ArithmeticException {
